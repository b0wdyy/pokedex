...
<template>
  <Container
    ...
    class="min-h-screen overflow-x-hidden py-4 pb-24 md:pb-0"
  >
    <header class="mb-3 flex items-center justify-between md:justify-end">
      <BackButton to="/" class="md:hidden" />
    ...
    <div>
      ...
      <div class="gap-12 md:grid md:grid-cols-2">
        ...
        <section class="mt-6 space-y-6 md:mt-0">
          ...
          <div v-if="evolutions.length">
            <h4 class="mb-2 text-sm font-bold uppercase text-white">
              Evolutie
            </h4>
